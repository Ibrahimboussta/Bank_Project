    ...
    <div class="flex">
        <div class="bg-slate-100 w-64 h-screen shadow-2xl">
            <div class="text-2xl p-4 flex flex-col justify-around items-stert ml-8 h-screen">
                ...
                <h1><a href="{{ route('facture') }}" class="no-underline hover:underline ">Facture</a></h1>
                ...
                <h1><a href=""
                        class="no-underline text-lg border border-black px-3 py-1 rounded-md hover:underline ">Log
                        out</a></h1>
            </div>
        </div>
        @yield('content')
