...
@section('content')
    <section class="w-[80vw] h-[80vh] me-5 border-2 rounded-3xl bg-slate-100 flex justify-center items-center  ">
                ...
                <div class=" p-20  ">
                    <div class="flex w-72 flex-col gap-6">
                        <div class="relative h-10 w-full min-w-[200px]">
                            ...
                            <input type="number" id="rib" name="rib"
                        ...
                        <div class="relative h-10 w-full min-w-[200px]">
                            ...
                            <select  name="card_number" id="card_number"
                                class="  peer h-full w-full rounded-[7px] border border-blue-gray-200 bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-yellow-400 focus:border-t-transparent focus:outline-0 focus:ring-0 disabled:border-0 disabled:bg-blue-gray-50">
                        ...
                        <div>
                            <button type="submit"
                                class="flex items-center bg-yellow-400 text-white gap-1 px-4 py-2 cursor-pointer  font-semibold tracking-widest rounded-md hover:bg-yellow-300 duration-300 hover:gap-2 hover:translate-x-3">
                                Send
